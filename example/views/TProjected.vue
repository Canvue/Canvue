<template>
  <div id="uv" class="uv" style="zoom:20%">
...
import {useProjectedCanvas} from "../../src/libs/useProjectedCanvas";
...
onMounted(() => {
  const {projected, bindStage} = useProjectedCanvas("pattern", {}, {})
  for (let item of list) {
    ...
    document.getElementById("uv").append(projected.lowerCanvasEl)
